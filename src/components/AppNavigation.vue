<template>
  <header :class="{ 
    ...
    <div class="nav-wrapper">
      <nav>
        <router-link to="/" @click.native="updateHeaderIndex()" class="nav-item">{{ selectedUser.name | firstName }}'s Home</router-link>
        <router-link to="/place" @click.native="updateHeaderPlace()" class="nav-item">{{ selectedUser.name | firstName }}'s Places</router-link>
        <router-link to="/group" @click.native="updateHeaderGroup()" class="nav-item">{{ selectedUser.name | firstName }}'s Group Trips</router-link>
